...
const items = [
  {
    ...
    description: 'We design and deploy custom neural networks, NLP pipelines, predictive models, and computer vision systems. Unlock complex automated reasoning tailored to your specific workloads.',
    accent: '#00f0ff',
  },
  {
    num: '02',
    title: 'Web Development',
    description: 'Engineering highly scalable, responsive web architectures. Leveraging modern JS frameworks to deliver lightning-fast load times, solid security, and immersive visual frontends.',
    accent: '#9945ff',
  },
  {
    num: '03',
    title: 'Mobile Apps',
    description: 'Crafting fluid native and hybrid mobile solutions. Combining smooth transitions, offline-first structures, and deep hardware integration to keep users hooked.',
    accent: '#10b981',
  },
  {
    num: '04',
    title: 'Automation Solutions',
    description: 'Streamlining enterprise operations with custom workflow automation pipelines. Connect legacy databases to intelligent API triggers to completely remove human overhead.',
    accent: '#f97316',
  },
  {
    num: '05',
    title: 'Cloud Infrastructure',
    description: 'Architecting robust, secure multi-region cloud infrastructures. Integrate automated CI/CD deployment pipelines, serverless models, and cost optimization layers.',
    accent: '#3b82f6',
  },
  {
    num: '06',
    title: 'UI/UX Design',
    description: 'Defining established design languages and high-end design systems. Combining user testing, micro-interactions, and premium layouts to build high-converting interfaces.',
    accent: '#ec4899',
  },
];

// Interactive SVG Animation Components for the Right Column
  ...
  return (
    <div className="relative w-full h-full max-w-[320px] max-h-[400px] flex items-center justify-center">
      ...
      >
        ...
        {/* Screen dashboard mock contents */}
...
function AutomationVisual() {
  return (
    <svg className="w-full h-full max-w-[400px] max-h-[400px]" viewBox="0 0 200 200">
      ...
      {/* Rotating gear inside automation */}
...
function CloudVisual() {
  return (
    <svg className="w-full h-full max-w-[400px] max-h-[400px]" viewBox="0 0 200 200">
      ...
      <path d="M 90 105 A 10 10 0 0 1 95 90 A 15 15 0 0 1 115 95 A 10 10 0 0 1 110 105 Z" fill="none" stroke="#3b82f6" strokeWidth="1.5" />

      {/* Connected Server Satellites */}
    ...
    <div className="w-full h-full max-w-[400px] max-h-[300px] flex flex-col gap-4">
      ...
      <div className="flex-1 rounded-2xl border border-white/10 glass-card p-5 relative overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          {/* Morphing High-Fidelity UI elements */}
          <motion.div
            animate={{
...
export default function Expertise() {
  ...
  // Correct Framer Motion API for subscribing to scroll progress
  useMotionValueEvent(scrollYProgress, 'change', (latest) => {
    ...
    const active = Math.min(
      totalItems - 1,
      Math.floor(latest * totalItems + 0.0001)
    );
  ...
  return (
    <section ref={containerRef} id="services" className="relative h-[600vh] bg-black">
      ...
      <div className="sticky top-0 w-full h-screen overflow-hidden z-20">
        ...
        {/* Full-height flex column: top label + stretched content grid */}
        <div className="h-full flex flex-col pt-24 pb-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Main two-column grid — grows to fill remaining height */}
            ...
            <div className="flex flex-col justify-center gap-6 h-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="h-[2px] flex-1 bg-white/10 relative overflow-hidden rounded-full">
                  <motion.div
                    className="absolute left-0 top-0 bottom-0 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full"
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <h3
                    className="font-display font-bold text-4xl sm:text-5xl tracking-tight leading-tight"
                    style={{
                      backgroundImage: `linear-gradient(135deg, #ffffff 25%, ${activeItem.accent} 100%)`,
                  ...
                  <p className="text-white/50 leading-relaxed font-light text-base sm:text-lg max-w-md">
              ...
              <div className="flex items-center gap-3">
                {items.map((item, idx) => (
                  <button
                    ...
                    className={`rounded-full transition-all duration-400 cursor-pointer focus:outline-none ${activeIdx === idx
            ...
            <div className="flex items-center justify-center h-full">
              <div className="relative w-full max-w-[420px] aspect-square flex items-center justify-center">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    {activeIdx === 1 && <WebVisual />}
                    {activeIdx === 2 && <MobileVisual />}
                    {activeIdx === 3 && <AutomationVisual />}
                    {activeIdx === 4 && <CloudVisual />}
                    {activeIdx === 5 && <DesignVisual />}
                  </motion.div>
                </AnimatePresence>
              </div>
            </div>
